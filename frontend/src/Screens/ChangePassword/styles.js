...
const styles = StyleSheet.create({
  ...
  contentContainer: tw`p-4 mt-4`,
  headingContainer: tw`border-b-2 border-gray-300 w-8/12 mt-4 pt-4 pb-4 self-center items-center`,
  ...
  img: tw`w-2/12 h-16`,
  card: tw`w-10/12`,
  buttonStyle: tw`w-full self-center rounded mb-5 bg-red-400`,
  paddingLeft: tw`pl-5 pr-5`,
});
