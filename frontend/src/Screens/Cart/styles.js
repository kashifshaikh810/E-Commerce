...
const styles = StyleSheet.create({
  ...
  productContainer: tw`w-3/12`,
  image: tw`w-full h-8`,
  tableContent: tw`w-11/12 flex-row justify-between items-center p-2.5 pl-0 m-2 mb-0`,
  tableContentTwo: tw`w-11/12 flex-1 h-40 flex-row justify-between items-center p-2.5 pl-0 m-2 mb-0 min-h-full`,
  buttonAndQuantityContainer: tw`flex-row justify-center w-4/12`,
